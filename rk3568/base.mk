...
TARGET_SD_RAW_FILENAME=FriendlyWrt-21_$(date +%Y%m%d)_RK3558_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=FriendlyWrt-21_$(date +%Y%m%d)_RK3568_arm64_eflasher.img
